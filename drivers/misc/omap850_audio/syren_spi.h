...
/* Locks SSPI for use by the MPU */
void syren_spi_lock(void);
/* Relinquishes MPU's lock on SSPI */
...
//int syren_wr(u_char page, u_char addr, u_short value, u_short change_mask);
//u_short syren_rd(u_char page, u_char addr);
