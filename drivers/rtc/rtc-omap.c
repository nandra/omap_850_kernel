...
/* This is very strange. The RTC registers are supposed to be the same as OMAP730
   and this file is supposed to support that. But on my device the RTC registers
   are 8 bits long, not 32 bits long. So redefining the addresses makes it work. */

#if (defined(CONFIG_ARCH_OMAP730) || defined(CONFIG_ARCH_OMAP850))

/* These are the addresses I have to use on OMAP850. Same as below divided by 4 */
...
#define OMAP_RTC_COMP_MSB_REG		0x18
...
#define OMAP_RTC_CTRL_SET_32_COUNTER	(1<<5) // I wonder if this doesn't have something to do with it? Tried toggling it but no effect??
